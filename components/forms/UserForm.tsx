                ...
                {activeTab === 'account' && (
                     <div className="space-y-1">
                        ...
                        <div>
                            ...
                            <select id="role" value={formData.role} onChange={handleChange} disabled={!isUserAdmin} className="w-full rounded-lg border border-cnk-border-light bg-cnk-bg-light p-2 disabled:opacity-50">
